...
func init() {
	...
	flag.StringVar(&tlsClientAllowList, "tls-client-allowlist", "", "the allowlist of client to be used with mutual tls auth")
...
func NewServer(api *operations.RekorServerAPI) *Server {
	...
	s.TLSClientAllowList = stringEnvOverride(tlsClientAllowList, "", "TLS_CLIENT_ALLOWLIST")
